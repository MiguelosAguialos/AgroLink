...
import "./VoluntarioRegisterForm.css";
...
import { createUserVoluntario } from "../../services/auth.service";

export default function VoluntarioRegisterForm(){
    ...
    const onSubmit = async (data) => {
        ...
        const res = await createUserVoluntario(user)
        if(res.code == 400){
          Swal.fire({
            title: res.title,
            text: res.message,
            ...
            >
              ...
              <div className="form-group">
                <input
                  type="text"
                  className="form-control"
                  {...register("tipoAlimentos", { required: true })}
                  placeholder="Tipo de Alimentos"
                />
              </div>
              <div className="form-group">
                <input
                  ...
                  placeholder="Disponibilidade (ex.: apenas aos finais de semana)"
                />
              </div>
